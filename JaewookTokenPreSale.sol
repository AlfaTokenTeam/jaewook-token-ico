...
import "./JaewookToken.sol";

contract JaewookTokenPreSale {
    JaewookToken public token;
    ...
    function JaewookTokenPreSale(
        JaewookToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = JaewookToken(_token);
        beneficiary = _beneficiary;
        alfatokenteam = _alfatokenteam;
        bonus = 30;
        price = 2000000;
        minSaleAmount = 5000000000000000000000;
    }
